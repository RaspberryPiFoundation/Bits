...
var Button = function Button(_ref) {
  var block = _ref.block,
      ...
      to = _ref.to,
      props = objectWithoutProperties(_ref, ['block', 'children', 'className', 'disabled', 'lightOnDark', 'secondary', 'to']);
  ...
  if (isLink()) {
    return React.createElement(
      Link$1,
      _extends({ className: classNames, excludeClassname: true, to: to }, props),
      children
    );
  }
  ...
  return React.createElement(
    reactIotacss.Base,
    _extends({ className: classNames, tagName: 'button' }, props),
    children
  );
};
...
var Card = function Card(_ref) {
  ...
  var cardChildren = function cardChildren() {
    return React.createElement(
      'div',
      null,
      imageJSX(),
...
var Figure = function Figure(_ref) {
  ...
  return React.createElement(
    reactIotacss.Base,
    _extends({ className: classNames, tagName: 'figure' }, props),
...
var Hr = function Hr(_ref) {
  ...
  return React.createElement(reactIotacss.Base, _extends({ className: classNames, tagName: 'hr' }, props));
};
...
var Type = function Type(_ref) {
  ...
  return React.createElement(
    reactIotacss.Base,
    _extends({ className: className, tagName: elementName }, props),
    children
  );
};
