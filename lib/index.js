...
var Link$1 = function Link$$1(_ref) {
  var children = _ref.children,
      ...
      props = objectWithoutProperties(_ref, ['children', 'className', 'href', 'routeTo']);
  ...
  if (href) {
    return React.createElement(
      'a',
      _extends({}, props, { className: classNames, href: href }),
      children
    );
  }
  ...
  return React.createElement(
    reactRouterDom.Link,
    _extends({}, props, { className: classNames, to: routeTo }),
    children
  );
};
