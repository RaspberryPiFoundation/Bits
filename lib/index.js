...
var Link$1 = function Link$$1(_ref) {
  var children = _ref.children,
      ...
      to = _ref.to,
      props = objectWithoutProperties(_ref, ['children', 'className', 'excludeClassname', 'to']);
  ...
  var anchorLink = React.createElement(
    reactIotacss.Base,
    _extends({}, props, { className: classNames, href: to, tagName: 'a' }),
    children
  );
...
var Slice = function Slice(_ref) {
  ...
  var classNames = classnames('c-slice', className);
