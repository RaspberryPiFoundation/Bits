...
var Link$2 = function (_React$Component) {
...
var NavLink = function NavLink(_ref) {
  ...
  return React.createElement(Route$1, {
    ...
    children: function children(_ref2) {
      ...
      return React.createElement(Link$2, _extends$3({
        to: to,
...
var StaticRouter$1 = function (_React$Component) {
  ...
  StaticRouter.prototype.render = function render() {
    ...
    return React.createElement(Router$1, _extends$9({}, props, { history: history }));
  };
...
var Link$$1 = function Link$$1(_ref) {
  var className = _ref.className,
      to = _ref.to,
      props = objectWithoutProperties(_ref, ['className', 'to']);

  var classes = classnames('c-link', className);

  return React.createElement(
    Link$2,
    _extends({ className: classes, to: to }, props),
    children
  );
};
