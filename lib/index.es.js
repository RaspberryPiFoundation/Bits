...
var Card = function Card(_ref) {
  var children = _ref.children,
      ...
      to = _ref.to,
      props = objectWithoutProperties(_ref, ['children', 'className', 'gridColumn', 'heading', 'imageAlt', 'imageSrc', 'imageTitle', 'to']);

  var isGridColumn = function isGridColumn() {
    return gridColumn;
  };
...
export { Button, Card, Link$1 as Link, Pagination, Wysiwyg };
