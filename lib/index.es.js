...
var Hr = function Hr(_ref) {
  ...
  return React.createElement(Base, _extends({ className: classNames, tagName: 'hr' }, props));
};
...
export { Base, Button, Card, Container, Figure, Grid, Hr, LightOnDark, Link$1 as Link, Media, Pagination, Panel, Slice, Type, TypeBase, TypeCaption, TypeDisplay, TypeDisplayLarge, TypeHeading, TypeSubHeading, Wysiwyg };
