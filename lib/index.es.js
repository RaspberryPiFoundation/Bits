...
var Card = function Card(_ref) {
  var children = _ref.children,
      ...
      routeTo = _ref.routeTo,
      props = objectWithoutProperties(_ref, ['children', 'className', 'heading', 'href', 'imageAlt', 'imageSrc', 'imageTitle', 'routeTo']);
  ...
  return React.createElement(
    'div',
    _extends({}, props, { className: classNames }),
    href || routeTo ? React.createElement(
      Link$1,
      { className: 'c-card--link', href: href, routeTo: routeTo },
      cardChildren
...
export { Button, Card, Link$1 as Link };
